...
export const HirePage = ({ onQuoteClick }) => {
  ...
  return (
    <div className="">
{/* Equipment Section */}
      <section id="equipment" className="py-6 sm:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-3 sm:space-y-8">
          {/* Mobile title at top */}
          <h2 className="block sm:hidden text-2xl font-bold text-gray-900">Find Your Perfect Equipment</h2>
          {/* Search and Filter Section */}
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.2 }}
            className="relative overflow-hidden rounded-xl shadow-md bg-center bg-cover bg-no-repeat min-h-[120px] sm:min-h-[260px]"
          ...
          >
            ...
            <h2 className="hidden sm:block text-2xl font-bold text-white mb-6">Find Your Perfect Equipment</h2>
            
            {/* Search Bar */}
            <div className="relative max-w-2xl mb-3 sm:mb-6">
              ...
              {searchQuery && (
                <button
                  onClick={clearSearch}
                  className="absolute inset-y-0 right-0 pr-3 flex items-center hover:bg-white/60 rounded-r-lg px-2 transition-colors touch-feedback min-h-[44px] min-w-[44px] px-3"
            ...
            {/* Mobile: Filter by Category dropdown */}
            <div className="sm:hidden mb-3">
              <label htmlFor="mobile-category" className="block text-sm font-medium text-white mb-2">
                Filter by Category:
              </label>
              <select
                id="mobile-category"
                ...
                className="w-full bg-white/90 text-gray-900 rounded-lg border border-white/40 px-3 py-3 min-h-[44px] focus:outline-none focus:ring-2 focus:ring-gold-500"
              >
              ...
              <div className="flex flex-wrap gap-2">
                {categories.map((category) => (
                  <motion.button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium text-base sm:text-sm transition-all duration-200 min-h-[44px] min-w-[44px] touch-feedback ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {loading ? (
            <motion.div 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="flex flex-col items-center justify-center py-10 sm:py-16 bg-white rounded-xl shadow-sm"
            >
            ...
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="text-center py-10 sm:py-16 bg-white rounded-xl shadow-sm"
            >
              ...
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-black font-semibold rounded-lg transition-colors shadow-sm focus:outline-none focus:ring-2 focus:ring-gold-500 focus:ring-offset-2"
              >
                Try Again
              </button>
            </motion.div>
            ...
            >
              ...
              <button
                ...
                className="px-4 py-2 sm:px-6 sm:py-3 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-black font-semibold rounded-lg transition-colors shadow-sm focus:outline-none focus:ring-2 focus:ring-gold-500 focus:ring-offset-2"
              >
            ...
            <AnimatePresence>
              <motion.div 
                ...
                className="grid grid-cols-2 sm:grid-cols-3 gap-1 sm:gap-3 md:gap-4 px-1 sm:px-0"
              >
                {filteredEquipment.map((item, index) => {
                  ...
                  return (
                    <motion.article
                      ...
                      className="group bg-white rounded-md shadow-sm overflow-hidden transition-all duration-300 border border-gray-100 hover:border-gold-200 flex flex-col h-full text-xs sm:text-sm md:text-sm justify-start card-touch"
                    ...
                    >
                      ...
                      <div className="p-1.5 sm:p-3 flex flex-col">
                        ...
                        <div className="mb-1.5 sm:mb-2 flex-grow">
                          <p 
                            className="text-gray-600 text-xs sm:text-sm line-clamp-1 sm:line-clamp-3"
                            aria-expanded={false}
                          >
                        ...
                        <div className="mt-1 sm:mt-2 grid grid-cols-2 gap-1 sm:gap-2">
                          <motion.button
                            ...
                            className="w-full py-1.5 sm:py-2 rounded-lg font-semibold transition-all duration-200 text-[11px] sm:text-sm bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-black focus:outline-none focus:ring-2 focus:ring-gold-500 focus:ring-offset-2"
                          ...
                          <motion.button
                            ...
                            className={`w-full py-1.5 sm:py-2 rounded-lg font-semibold transition-all duration-200 text-[11px] sm:text-sm flex items-center justify-center ${
                              isAvailable 
                                ? 'bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-black focus:outline-none focus:ring-2 focus:ring-gold-500 focus:ring-offset-2' 
      ...
      <section className="py-10 sm:py-16 bg-gradient-to-r from-gray-900 to-black text-white">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={() => onQuoteClick({ type: 'custom' })}
                className="px-8 py-3 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-black font-semibold rounded-lg transition-colors shadow-lg focus:outline-none focus:ring-2 focus:ring-gold-500 focus:ring-offset-2"
              >

...
<head>
  ...
  <title>Quote Confirmation | ${companyConfig.name}</title>
  <style>
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="highlight">
        <p><strong>Quote Reference:</strong> ${quote.reference || quote._id}</p>
      ...
      <div class="contact-section">
        ...
        <div class="contact-info">
          ...
          <div class="contact-item">
            ...
            <a href="${companyConfig.website}">${companyConfig.website.replace('https://', '')}</a>
          </div>
          <div class="contact-item">
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>New Quote Request | ${companyConfig.name} Admin</title>
  <style>
    @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap');
...
<body>
  <div class="container">
    <div class="header">
      ...
      <p>REF: ${quote.reference || quote._id}</p>
    </div>
    ...
    <div class="content">
      ...
      <div class="action-buttons">
        <a href="${companyConfig.frontendUrl}/admin/quotes/${quote._id}" class="btn btn-view">View Details</a>
        <a href="${companyConfig.backendUrl}/api/quotes/${quote._id}/status?action=approve" class="btn btn-approve">Approve Quote</a>
        <a href="${companyConfig.backendUrl}/api/quotes/${quote._id}/status?action=reject" class="btn btn-reject">Reject Quote</a>
      </div>
